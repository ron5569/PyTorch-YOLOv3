...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_def", type=str, default="config/yolov3-custom3.cfg", help="path to model definition file")
    parser.add_argument("--weights_path", type=str, default="checkpoints/yolov3_ckpt_.pth", help="path to weights file")
    parser.add_argument("--class_path", type=str, default="data/thermal.names", help="path to class label file")
    ...
    if opt.weights_path.endswith(".weights"):
        ...
        model.load_state_dict(torch.load(opt.weights_path, map_location=available_else_cpu), strict = False)
